const services = [
...

    {
      ...
      {
        title: "Wellcome Calls ",
        paragraph: "La plataforma facilita la validación de datos de clientes en formato de voz para el proceso de Onboarding, gestionando mensajes de bienvenida definidos por usted. Aprueba o rechaza solicitudes basándose en las validaciones. Se integra con sistemas internos, permite una implementación rápida en días y es configurable según sus necesidades.",
        image: "../public/assets/images/analiticas.png",
        id:crypto.randomUUID()
      },
      ...
      {
        title: "Field Service        ",
        paragraph: "La solución Field Service ofrece atención omnicanal para gestionar casos de field service, ya sea de forma 100% autogestionable o parcial. Se adapta a las particularidades de los casos más frecuentes, integra sus sistemas de gestión y permite la gestión de imágenes o accesos multimedia según sea necesario.",
        image: "../public/assets/images/analiticas.png",
        id:crypto.randomUUID()
      },
